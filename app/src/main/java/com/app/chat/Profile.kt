...
open class Profile : Fragment() {
       ...
       val rootView= inflater.inflate(R.layout.fragment_profile, container, false)
        ...
        FirebaseDatabase.getInstance().getReference("users/${user!!.uid}").addValueEventListener(object:ValueEventListener{
            ...
            override fun onDataChange(snap: DataSnapshot?) {
                ...
                rootView.profileUserName.text = myUser!!.Name
                ...
                rootView.profileActions.setOnClickListener {
                    ...
                    val items = arrayOf("Edit Profile")
    ...
    fun checkPermissions():Boolean{
        val readStoragePermissionGranted = ContextCompat.checkSelfPermission(Activity,android.Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
        return if(readStoragePermissionGranted) true else false
    }

    fun requestPermissions(){
        val readStoragePermission = android.Manifest.permission.READ_EXTERNAL_STORAGE
        val permissions = arrayOf(readStoragePermission)
